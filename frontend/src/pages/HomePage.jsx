            ...
            <Container fluid className="main-container bg-dark text-white p-0">
                ...
                <Container className="mt-4">
                    <Row className="justify-content-center">
                        {user && user.role === 'artist' && (
                            <Col xs={12} sm={6} md={4} lg={4} className="mb-3 d-flex">
                                <Card className="bg-secondary text-white p-0 flex-fill">
                                    <Card.Img variant="top" src="/microfono.avif" alt="Mic" className="card-img-top-no-margin fixed-dimension" />
                        ...
                        <Col xs={12} sm={6} md={4} lg={4} className="mb-3 d-flex">
                            <Card className="bg-secondary text-white p-0 flex-fill">
                                <Card.Img variant="top" src="/mpc.jpg" alt="mpc" className="card-img-top-no-margin fixed-dimension" />
                                <Card.Body className="d-flex flex-column">
                        ...
                        <Col xs={12} sm={6} md={4} lg={4} className="mb-3 d-flex">
                            <Card className="bg-secondary text-white p-0 flex-fill">
                                <Card.Img variant="top" src="/session.webp" alt="session" className="card-img-top-no-margin fixed-dimension" />
                                <Card.Body className="d-flex flex-column">
                        ...
                        {user && user.role === 'producer' && (
                            <Col xs={12} sm={6} md={4} lg={4} className="mb-3 d-flex">
                                <Card className="bg-secondary text-white p-0 flex-fill">
                                    <Card.Img variant="top" src="/mixer-upload.jpeg" alt="mixer" className="card-img-top-no-margin fixed-dimension" />
                                    <Card.Body className="d-flex flex-column">
